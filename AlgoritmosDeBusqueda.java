...
public class AlgoritmosDeBusqueda {
    public static void main(String[] args) {
        ...
        // Se define un arreglo de ejemplo. Uno desordenado y otro ordenado para la búsqueda binaria
        ...
        System.out.println("--- inicio búsqueda lineal ---");
        ...
        System.out.println("--- inicio búsqueda lineal con centinela ----");
        imprimirArreglo(arregloDesordenado);
        ...
        System.out.println("Se presenta la siguiente lista de strings: ");
