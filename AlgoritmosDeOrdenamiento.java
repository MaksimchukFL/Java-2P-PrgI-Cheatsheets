public class AlgoritmosDeOrdenamiento {
    public static void main(String[] args) {
        ...
        // Este es el arreglo de prueba
        int[] arreglo = { 5, 6, 99, 1, 0, 3 };

        // Imprimo el arreglo de prueba
        System.out.println("Este es el arreglo de prueba: ");
        imprimirArreglo(arreglo);
        System.out.println("----");

        /* Cada algoritmo es un método que recibe como parámetro el arreglo y lo ordena, imprimiendo
        cada paso que realiza. */
        System.out.println("Este es el método burbuja: ");
        burbuja(arreglo);
        System.out.println("Este es el método de inserción: ");
        insercion(arreglo);
        System.out.println("Este es el método por selección: ");
        seleccion(arreglo);
    }
